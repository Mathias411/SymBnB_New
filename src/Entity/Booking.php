...
class Booking
{
    ...
    /**
     * @ORM\Column(type="datetime")
     * @Assert\GreaterThan(propertyPath="startDate", message="La date de départ ne peux pas être antérieur à la date d'arrivé")
     */
    private $endDate;
    ...
    public function isBookableDates(){
        // 1) Il faut connaitre lse dates qui sont impossibles pour l'annonce
